...
# neuroglancer / .viewer / ..flythrough are used only by the notebook-era prototypes below
# (add_tube_layers, tube_prototype) -- imported lazily inside them so importing this module
# (via service.py, on the headless HTTP path) doesn't pull in neuroglancer + ipywidgets.
